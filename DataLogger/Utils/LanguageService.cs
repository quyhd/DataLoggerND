...
namespace DataLogger.Utils
{
    ...
    public class LanguageService
    {
        ...
        private List<LanguageInfo> languageList = new List<LanguageInfo>
        {
            ...
            new LanguageInfo{ Language = ELanguage.English, Code = "en", Name = "France", Icon = Resources.Flag_of_Vietnam_43x32},
            new LanguageInfo{ Language = ELanguage.Vietnamese, Code = "fa", Name = "English", Icon = Resources.en  }
        };
